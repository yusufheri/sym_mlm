...
class AdvanceMemberType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('imageFile', FileType::class, $this->getConfiguration("Logo de l'entreprise", "Le logo de l'entreprise", ["required" => false]))
            ...
            ->add('description', TextareaType::class, $this->getConfiguration("Description du l'enreprise ", "Decrivez en quelques mots l'activité du nouveau membre"))
